...
class _$InitialImpl with DiagnosticableTreeMixin implements _Initial {
  ...
  int get hashCode => Object.hash(runtimeType, firstName, lastName, email,
      password, confirmPassword, isRegistered, isLoading, errorMessage, status);
  ...
  TResult when<TResult extends Object?>({
    ...
    return initial(firstName, lastName, email, password, confirmPassword,
        isRegistered, isLoading, errorMessage, status);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return initial?.call(firstName, lastName, email, password, confirmPassword,
        isRegistered, isLoading, errorMessage, status);
  }
